...
<h2>Change Last Name</h2></br>
<form method="post" action="elnamecode.jsp" >
...
<p>New Name</p>
<input type="text" name="lnname" required="" placeholder="Enter your new last name"/>
<input type="submit" name="changelname" value="Change Last Name"/>
</form>
</div>
